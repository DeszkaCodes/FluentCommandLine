...
public partial interface IRootCommandHasToSetHandler
{
    ...
    new IRootCommandCanSetProperties SetHandler(Func<Task> handle);

    /// <returns>An <see cref="IRootCommandCanSetProperties"/> with the new handler.</returns>
    /// <inheritdoc cref="ICommandBaseHasToSetHandler.SetHandler(Func{InvocationContext, Task})"/>
    new IRootCommandCanSetProperties SetHandler(Func<InvocationContext, Task> handle);

    /// <returns>An <see cref="IRootCommandCanSetProperties"/> with the new handler.</returns>
    /// <inheritdoc cref="ICommandBaseHasToSetHandler.SetHandler{T}(Func{T, Task}, IValueDescriptor{T})"/>
    new IRootCommandCanSetProperties SetHandler<T>(Func<T, Task> handle, IValueDescriptor<T> symbol);
    ...
    new IRootCommandCanSetProperties SetHandler<T1, T2>(Func<T1, T2, Task> handle,
    ...
    new IRootCommandCanSetProperties SetHandler<T1, T2, T3>(Func<T1, T2, T3, Task> handle,
        IValueDescriptor<T1> symbol1,
        IValueDescriptor<T2> symbol2,
    ...
    new IRootCommandCanSetProperties SetHandler<T1, T2, T3, T4>(Func<T1, T2, T3, T4, Task> handle,
        IValueDescriptor<T1> symbol1,
        IValueDescriptor<T2> symbol2,
        IValueDescriptor<T3> symbol3,
    ...
    new IRootCommandCanSetProperties SetHandler<T1, T2, T3, T4, T5>(Func<T1, T2, T3, T4, T5, Task> handle,
        IValueDescriptor<T1> symbol1,
        IValueDescriptor<T2> symbol2,
        IValueDescriptor<T3> symbol3,
        IValueDescriptor<T4> symbol4,
    ...
    new IRootCommandCanSetProperties SetHandler<T1, T2, T3, T4, T5, T6>(Func<T1, T2, T3, T4, T5, T6, Task> handle,
        IValueDescriptor<T1> symbol1,
        IValueDescriptor<T2> symbol2,
        IValueDescriptor<T3> symbol3,
        IValueDescriptor<T4> symbol4,
    ...
    new IRootCommandCanSetProperties SetHandler<T1, T2, T3, T4, T5, T6, T7>(Func<T1, T2, T3, T4, T5, T6, T7, Task> handle,
        IValueDescriptor<T1> symbol1,
        IValueDescriptor<T2> symbol2,
        IValueDescriptor<T3> symbol3,
        IValueDescriptor<T4> symbol4,
    ...
    new IRootCommandCanSetProperties SetHandler<T1, T2, T3, T4, T5, T6, T7, T8>(Func<T1, T2, T3, T4, T5, T6, T7, T8, Task> handle,
        IValueDescriptor<T1> symbol1,
        IValueDescriptor<T2> symbol2,
        IValueDescriptor<T3> symbol3,
        IValueDescriptor<T4> symbol4,
